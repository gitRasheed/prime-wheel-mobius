...
\end{proof}
\leanxref{Lean explicit-Dirichlet equivalence}{primorialWheelDirichletNonconcentration_iff_harmonic}{https://github.com/OVVO-Financial/prime-wheel-mobius/blob/main/formalization/RHLean/Analysis/PrimorialWheelExplicitCriterion.lean}
